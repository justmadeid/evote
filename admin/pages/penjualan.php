        ...
        <div class="col-md-6">
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="callout callout-info"><i class="fa fa-edit"></i>  Input Penjualan</div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <form></form>
              ...
              <div class="input-group">
                <span class="input-group-addon"><li class="fa fa-sticky-note"></li></span>
                <input type="text" class="form-control" placeholder="00001" disabled>
              </div>
