...
<?php
$query = "SELECT max(kodes) as maxKode FROM supplier";
                ...
                <section class="content">
                  ...
                  <h4>KODE</h4>
                              <div class="input-group">
                                ...
                                <input type="text" readonly="" class="form-control" name="kodes" placeholder="Kode" value="<?php echo $newID ?>">
                              </div>
                  <h4>Nama</h4>
      ...
      <div class="row">
        ...
        Tambah Supplier &nbsp<li class="fa fa-plus"></li>
            ...
            <div class="box-header">
              <h3 class="box-title">Data Supplier</h3><h3 class="box-title pull-right"><a href="#modal-info" data-toggle="modal" data-target="#modal-info"><li class="fa fa-info-circle" style="color: #00C0EF;"></li></a></h3> 
            </div>
            <?php
          ...
          <div class="modal-dialog">
            <div class="modal-content" style="border-radius:5px;margin-top:100px;">
              <div class="modal-header bg-aqua">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title">Informasi Supplier</h4>
              </div>
                <div class="modal-body">
                  <section class="content">
                    <div class="row">
                          ...
                          <div class="box-header">
                            ...
                            <table class="table table-striped">
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php
                                  $bar = mysqli_query($conn,"SELECT * FROM supplier");
                              ...
                              <tr>
                                <td>Supplier TerPublish</td>
                                <td>
                                  <?php
                                  $bar = mysqli_query($conn,"SELECT * FROM supplier WHERE flag=1");
                                  $ok = mysqli_num_rows($bar);
                              ...
                              <tr>
                                <td>Supplier Tidak Publish</td>
                                <td>
                                  <?php
                                  $bar = mysqli_query($conn,"SELECT * FROM supplier WHERE flag=0");
                                  $ok = mysqli_num_rows($bar);
